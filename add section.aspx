<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add section.aspx.cs" Inherits="add_section" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="add-button">
                ...
                <asp:Label ID="courseAddedPrompt" runat="server" Text="Section Added." Visible="false" CssClass="prompt" />

            </div>
            <div class="data-entry-form">
                <p>Section Name: <asp:TextBox ID="sectionNameTextBox" runat="server"></asp:TextBox></p>
                <p>Section name to take students from: <asp:TextBox ID="studentRollNumberTextBox" runat="server"></asp:TextBox></p>
